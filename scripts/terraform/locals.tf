locals {
  ...
  # 镜像版本：flink1.13.0
  instance_image_id_maps_v1130 = {
    #     北京4
    cn-north-4 = "3ad6109d-eebd-4dd1-bc27-877e7dbb4cbb"

  }
  # 1.17.0版本增加（注意修改var参数和镜像的版本的判断部分）
  instance_image_id_maps_v1170 = {
    #     北京4
    cn-north-4 = "7eb1c9c9-c397-45f3-97c1-ffc80aaded62"
